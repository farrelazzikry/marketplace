...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.products.index')->with('success', 'Produk berhasil ditambah (Session)');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (isset($products[$id])) {
            ...
            $products[$id]['price'] = $request->price; // Simpan apa adanya buat demo
            $products[$id]['category_id'] = $request->category_id;
            $products[$id]['size'] = $request->size;
            $products[$id]['desc'] = $request->desc;
