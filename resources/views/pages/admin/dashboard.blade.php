...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {{-- Card Total Produk --}}
        <x-admin.ui.card title="Total Produk" :value="$totalProducts">
        ...
        {{-- Card Total Pesanan --}}
        <x-admin.ui.card title="Total Pesanan" :value="$totalOrders">
        ...
        <x-admin.ui.card title="Pesanan Pending" :value="$pendingOrders">
        ...
        <x-admin.ui.card title="Pembayaran Pending" :value="$pendingPayments">
